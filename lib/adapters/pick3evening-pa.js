...
export const pick3eveningpaRecent = [// Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3eveningpa',
    regions: ['PA'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick3eveningpa',
    regions: ['PA'],
    url:"http://www.lotteryusa.com/pennsylvania/pick-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick3eveningpaNext = [
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/168',

...
export const daily4middayinRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily4middayin',
    regions: ['IN'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'daily4middayin',
    regions: ['IN'],
    url:"http://www.lotteryusa.com/indiana/midday-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const daily4middayinNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily4middayin',
    regions: ['IN'],
      ...
      date: {      
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/62',

...
const backupURL = 'https://www.lotterypost.com/game/278';
const jackpotURL = 'http://lotterycorner.com/results/tn/cash-4-evening-winning-numbers.html';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getData } from '../helpers/getData';

export const cash4eveningtnRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'cash4eveningtn',
    regions: ['TN'],
    url:gameURL,
    data: {
      numbers: {
...
export const cash4eveningtnNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'cash4eveningtn',
    regions: ['TN'],

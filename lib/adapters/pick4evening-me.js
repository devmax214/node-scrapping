...
export const pick4eveningmeRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4eveningme',
    regions: ['ME', 'NH', 'VT'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick4eveningme',
    regions: ['ME', 'NH', 'VT'],
    url:"http://www.lotteryusa.com/maine/pick-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick4eveningmeNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4eveningme',
    regions: ['ME', 'NH', 'VT'],
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/127',

...
export const lottoplus1Recent = [
  // scraper for the recently passed draw (primary)
  {
    lotteryName: "lottoplus1",
    regions: ["IE"],
    url: "https://www.lottery.ie/prizes-and-results/?game=lotto",
    data: {
      numbers: {
        path: "img[src*='LottoPlus1']",
  ...
  // scraper for the recently passed draw (backup)
  {
    lotteryName: "lottoplus1",
    regions: ["IE"],
    url: "https://irish.national-lottery.com/irish-lotto/plus-1",
    data: {
      numbers: {

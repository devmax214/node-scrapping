...
export const georgiafiveeveninggaRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'georgiafiveeveningga',
    regions: ['GA'],
    url:"https://www.lotterypost.com/game/382",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'georgiafiveeveningga',
    regions: ['GA'],
    url:"http://www.lotteryusa.com/georgia/georgia-five/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const georgiafiveeveninggaNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'georgiafiveeveningga',
    regions: ['GA'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    ...
    data: {
      jackpot: {
        path: 'tr:contains("Georgia FIVE") span.next-jackpot-amount',
        transform: async (html) => {
      ...
      date: {
        path: 'tr:contains("Georgia FIVE") span.next-draw-date',
        transform: async (html) => {

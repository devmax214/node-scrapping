...
export const megabucksdoublerNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'megabucksdoubler',
    regions: ['MA'],

...
export const pick4middaynjRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4middaynj',
    regions: ['NJ'],
    url:"https://www.lotterypost.com/game/135",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick4middaynj',
    regions: ['NJ'],
    url:"http://www.lotteryusa.com/new-jersey/midday-pick-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick4middaynjNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4middaynj',
    regions: ['NJ'],

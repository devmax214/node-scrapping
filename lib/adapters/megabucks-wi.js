...
const gameTitle = 'Very Own Megabucks';
const gameURL = 'http://www.lotteryusa.com/wisconsin/';
const backupURL = 'https://www.lotterypost.com/game/215';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getJackpot, getNextJackpot } from '../helpers/lotteryPost';

export const megabuckswiRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'megabuckswi',
    regions: ['WI'],
    url:gameURL,
    data: {
      numbers: {

...
export const daily4wvRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily4wv',
    regions: ['WV'],
    url:"http://www.wvlottery.com/draw-games/historical-search/daily-4/6",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'daily4wv',
    regions: ['WV'],
    url:"http://www.lotteryusa.com/west-virginia/daily-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/207',

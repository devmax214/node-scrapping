...
const gameTitle = 'Big Sky Bonus';
const gameURL = 'http://www.lotteryusa.com/montana/';
const backupURL = 'https://www.lotterypost.com/game/494';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getJackpot, getNextJackpot } from '../helpers/lotteryPost';

export const bigskybonusRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'bigskybonus',
    regions: ['MT'],
    url:gameURL,
    data: {
      numbers: {

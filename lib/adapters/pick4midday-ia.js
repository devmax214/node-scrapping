...
export const pick4middayiaRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4middayia',
    regions: ['IA'],
    url:"http://www.ialottery.com/Games/Online/Pick4MWin.asp",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick4middayia',
    regions: ['IA'],
    url:"http://www.lotteryusa.com/iowa/midday-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick4middayiaNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4middayia',
    regions: ['IA'],

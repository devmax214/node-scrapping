...
export const win4eveningRecent = [
  // scraper for the recently passed draw (primary)
  {
    lotteryName: "win4evening",
    regions: ["NY"],
    url: "http://www.lotteryusa.com/new-york/win-4/",
    data: {
      numbers: {
        path: "ul.draw-result",
  ...
  // scraper for the recently passed draw (backup)
  {
    lotteryName: "win4evening",
    regions: ["NY"],
    url: "https://www.lotterypost.com/game/149",
    data: {
      numbers: {
        path: "div.resultsRow",
        transform: async (html) => {
  ...
  // scraper for the next draw (primary)
  {
    ...
    data: {
      jackpot: {
        ...
        transform: async (html) => {
          let game_row = html.last().parent().parent();

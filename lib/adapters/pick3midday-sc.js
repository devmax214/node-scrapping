...
export const pick3middayscRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3middaysc',
    regions: ['SC'],
    url:"https://www.lotterypost.com/game/223",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick3middaysc',
    regions: ['SC'],
    url:"http://www.lotteryusa.com/south-carolina/midday-pick-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick3middayscNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3middaysc',
    regions: ['SC'],

...
export const pick3middayohRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3middayoh',
    regions: ['OH'],
    url:"https://www.lotterypost.com/game/153",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick3middayoh',
    regions: ['OH'],
    url:"http://www.lotteryusa.com/ohio/midday-pick-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick3middayohNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3middayoh',
    regions: ['OH'],

...
export const pick4eveningpaRecent = [// Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4eveningpa',
    regions: ['PA'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick4eveningpa',
    regions: ['PA'],
    url:"http://www.lotteryusa.com/pennsylvania/pick-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick4eveningpaNext = [
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/166',

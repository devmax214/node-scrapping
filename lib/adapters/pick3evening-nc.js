...
export const pick3eveningncRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3evening-nc',
    regions: ['NC'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick3evening-nc',
    regions: ['NC'],
    url:"http://www.lotteryusa.com/north-carolina/pick-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick3eveningncNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3evening-nc',
    regions: ['NC'],
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/310',

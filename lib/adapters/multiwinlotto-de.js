...
const gameURL = 'http://www.lotteryusa.com/delaware/';
const backupURL = 'https://www.lotterypost.com/game/272';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getJackpot, getNextJackpot } from '../helpers/lotteryPost';

export const multiwinlottoRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'multiwinlotto',
    regions: ['DE'],
    url:gameURL,
    data: {
      numbers: {
...
export const multiwinlottoNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'multiwinlotto',
    regions: ['DE'],

...
export const allornothingmorninggaRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'allornothingmorningga',
    regions: ['GA'],
    url:"https://www.lotterypost.com/game/458",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'allornothingmorningga',
    regions: ['GA'],
    url:"http://www.lotteryusa.com/georgia/morning-all-or-nothing/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const allornothingmorninggaNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'allornothingmorningga',
    regions: ['GA'],

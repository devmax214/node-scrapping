...
const gameTitle = 'Quick Draw';
const gameURL = 'http://www.lotteryusa.com/indiana/';
const backupURL = 'https://www.lotterypost.com/game/349';
...
export const quickdraweveningRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'quickdrawevening',
    regions: ['IN'],
    url:gameURL,
    data: {
      numbers: {
...
export const quickdraweveningNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'quickdrawevening',
    regions: ['IN'],

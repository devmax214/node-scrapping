...
const gameTitle = 'Midday Pega 2';
const gameURL = 'http://www.lotteryusa.com/puerto-rico/';
const backupURL = 'https://www.lotterypost.com/game/431';
const jackpotURL = 'http://www.loteriasdepuertorico.com/juegos/pega2/';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getData } from '../helpers/getData';

export const pega2dayRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pega2day',
    regions: ['PR'],
    url:gameURL,
    data: {
      numbers: {

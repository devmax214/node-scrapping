...
const gameTitle = 'Mass Cash';
const gameURL = 'http://www.lotteryusa.com/massachusetts/';
const backupURL = 'https://www.lotterypost.com/game/96';
const jackpotURL = 'http://www.masslottery.com/games/lottery/mass-cash.html';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getData } from '../helpers/getData';

export const masscashRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'masscash',
    regions: ['MA'],
    url:gameURL,
    data: {
      numbers: {
      ...
      jackpot: {
        ...
        transform: async (html) => {
          let nextJackpot = await getData({
            url: jackpotURL,
            path: '#tab-how-to-win table tr:nth-child(2) td:nth-child(3)',
            transform: async (html) => {

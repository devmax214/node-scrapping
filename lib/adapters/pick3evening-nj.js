...
export const pick3eveningnjRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3evening-nj',
    regions: ['NJ'],
    url:"https://www.lotterypost.com/game/136",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick3evening-nj',
    regions: ['NJ'],
    url:"http://www.lotteryusa.com/new-jersey/pick-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick3eveningnjNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3evening-nj',
    regions: ['NJ'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    ...
    data: {
      ...
      date: {
        ...
        transform: async (html) => {
          const text = html.first().text();
          const date = await moment(text, "ddd, MMM DD, YYYY").add({days:1}).format();
          return date;
        }
      }
    }

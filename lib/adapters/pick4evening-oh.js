...
export const pick4eveningohRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4eveningoh',
    regions: ['OH'],
    url:"https://www.ohiolottery.com/mobile/pick-4",
    data: {
      numbers: {
        path: 'li.pick4:contains("Evening") ul.balls',
      ...
      date: {
        path: 'li.pick4:contains("Evening") span.date',
        transform: async (html) => {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick4eveningoh',
    regions: ['OH'],
    url:"http://www.lotteryusa.com/ohio/pick-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick4eveningohNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4eveningoh',
    regions: ['OH'],
    url:"https://www.lotterypost.com/game/156",
    data: {
      jackpot: {
       path: 'div',
        transform: async (html) => {

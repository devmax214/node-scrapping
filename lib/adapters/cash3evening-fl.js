...
const gameTitle = 'Pick 3';
const gameURL = 'http://www.lotteryusa.com/florida/';
const backupURL = 'https://www.lotterypost.com/game/33';
...
export const cash3eveningflRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'cash3eveningfl',
    regions: ['FL'],
    url:gameURL,
    data: {
      numbers: {
...
export const cash3eveningflNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'cash3eveningfl',
    regions: ['FL'],

...
const gameURL = 'http://www.lotterycanada.com/ontario-pick-3-midday';
const backupURL = 'https://www.lotterypost.com/game/402';
...
export const middaypick3Recent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'middaypick3',
    regions: ['ON'],
    url:gameURL,
    data: {
      numbers: {

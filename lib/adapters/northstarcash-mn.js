...
const gameTitle = 'Northstar Cash';
const gameURL = 'http://www.lotteryusa.com/minnesota/';
const backupURL = 'https://www.lotterypost.com/game/222';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getJackpot, getNextJackpot } from '../helpers/lotteryPost';

export const northstarcashRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'northstarcash',
    regions: ['MN'],
    url:gameURL,
    data: {
      numbers: {
...
export const northstarcashNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'northstarcash',
    regions: ['MN'],

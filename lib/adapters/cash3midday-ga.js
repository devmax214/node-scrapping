...
const backupURL = 'https://www.lotterypost.com/game/42';
const jackpotURL = 'https://www.galottery.com/en-us/games/draw-games/cash-three.html#tab-winningNumbers';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getData } from '../helpers/getData';

export const cash3middaygaRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'cash3middayga',
    regions: ['GA'],
    url:gameURL,
    data: {
      numbers: {
...
export const cash3middaygaNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'cash3middayga',
    regions: ['GA'],

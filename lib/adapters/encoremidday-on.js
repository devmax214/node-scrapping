...
export const encoremiddayonRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'encoremidday-on',
    regions: ['ON'],
    url:"http://www.lotterycanada.com/encore-midday",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'encoremidday-on',
    regions: ['ON'],
    url:"https://www.lotterypost.com/game/407",
    data: {
      numbers: {
...
export const encoremiddayonNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'encoremidday-on',
    regions: ['ON'],

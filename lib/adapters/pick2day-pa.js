...
const gameTitle = 'Midday Pick 2';
const gameURL = 'http://www.lotteryusa.com/pennsylvania/';
const backupURL = 'https://www.lotterypost.com/game/481';
const jackpotURL = 'https://www.palottery.state.pa.us/Games/PICK-2/Prizes-Chances.aspx';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getData } from '../helpers/getData';

export const pick2dayRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick2day',
    regions: ['PA'],
    url:gameURL,
    data: {
      numbers: {
      ...
      jackpot: {
        ...
        transform: async (html) => {
          let nextJackpot = await getData({
            url: jackpotURL,
            path: '#games4 tbody tr:first-child td:nth-child(4)',
            transform: async (html) => {

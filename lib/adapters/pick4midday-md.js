...
export const pick4middaymdRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4middaymd',
    regions: ['MD'],
    url:"http://www.mdlottery.com/winning-numbers/",
    data: {
      numbers: {
        path: 'tr:nth-child(2) td:nth-child(6) strong',
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick4middaymd',
    regions: ['MD'],
    url:"http://www.lotteryusa.com/maryland/midday-pick-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick4middaymdNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4middaymd',
    regions: ['MD'],
      ...
      date: {
        ...
        transform: async (html) => {
          let date = await getData({
            url: 'https://www.lotterypost.com/game/92',

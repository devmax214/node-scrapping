...
export const eveningpick4onRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'eveningpick4on',
    regions: ['ON'],
    url:"http://www.lotterycanada.com/ontario-pick-4",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'eveningpick4on',
    regions: ['ON'],
    url:"https://www.lotterypost.com/game/297",
    data: {
      numbers: {
      ...
      jackpot: {
        ...
        transform: async (html) => {
          let jackpot = await getData({
            url: 'http://www.olg.ca/lotteries/games/howtoplay.do?game=pick-4',
            path: 'tr:contains("1 in 10,000") > td:nth-child(2) > div.data',
            transform: async (html) => {
...
export const eveningpick4onNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'eveningpick4on',
    regions: ['ON'],

...
export const pick5daypaRecent = [// Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick5daypa',
    regions: ['PA'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick5daypa',
    regions: ['PA'],
    url:"http://www.lotteryusa.com/pennsylvania/midday-pick-5/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick5daypaNext = [
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/340',
  ...
  // Scraper for the recently passed draw (Backup)
  {
    ...
    data: {
      jackpot: {
        path: 'tr:contains("Midday Pick 5") span.next-jackpot-amount',
        transform: async (html) => {
      ...
      date: {
        path: 'tr:contains("Midday Pick 5") span.next-draw-date',
        transform: async (html) => {

...
const gameTitle = 'Midday 4';
const gameURL = 'http://www.lotteryusa.com/illinois/';
const backupURL = 'https://www.lotterypost.com/game/54';
const jackpotURL = 'http://www.lotteryusa.com/illinois/midday-4/';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getData } from '../helpers/getData';

export const midday4fireballRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'midday4fireball',
    regions: ['IL'],
    url:gameURL,
    data: {
      numbers: {
...
export const midday4fireballNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'midday4fireball',
    regions: ['IL'],

...
export const pick4eveningscRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4eveningsc',
    regions: ['SC'],
    url:"https://www.lotterypost.com/game/176",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick4eveningsc',
    regions: ['SC'],
    url:"http://www.lotteryusa.com/south-carolina/pick-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick4eveningscNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4eveningsc',
    regions: ['SC'],

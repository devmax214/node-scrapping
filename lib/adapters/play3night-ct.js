...
export const play3nightctRecent = [// Scraper for the recently passed draw (Primary)
  {
    lotteryName:'play3nightct',
    regions: ['CT'],
    url:"https://www.ctlottery.org/Modules/Games/default.aspx?id=3&winners=1",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'play3nightct',
    regions: ['CT'],
    url:"http://www.lotteryusa.com/connecticut/play-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/17',

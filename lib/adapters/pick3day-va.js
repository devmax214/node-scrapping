...
export const pick3dayvaRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3dayva',
    regions: ['VA'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick3dayva',
    regions: ['VA'],
    url:"http://www.lotteryusa.com/virginia/midday-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
      ...
      date: {
        ...
        transform: async (html) => {
          let date = await getData({
            url: 'https://www.lotterypost.com/game/192',

...
const gameTitle = 'Natural State Jackpot';
const gameURL = 'http://www.lotteryusa.com/arkansas/';
const backupURL = 'https://www.lotterypost.com/game/412';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getJackpot, getNextJackpot } from '../helpers/lotteryPost';

export const naturalstatejackpotRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'naturalstatejackpot',
    regions: ['AR'],
    url:gameURL,
    data: {
      numbers: {
...
export const naturalstatejackpotNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'naturalstatejackpot',
    regions: ['AR'],

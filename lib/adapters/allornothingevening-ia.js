...
export const allornothingeveningiaRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'allornothingeveningia',
    regions: ['IA', 'MN'],
    url:"http://www.ialottery.com/Games/Online/AONWinE.asp",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'allornothingeveningia',
    regions: ['IA', 'MN'],
    url:"http://www.lotteryusa.com/iowa/all-or-nothing/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const allornothingeveningiaNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'allornothingeveningia',
    regions: ['IA', 'MN'],
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/455',
  ...
  // Scraper for the recently passed draw (Backup)
  {
    ...
    data: {
      ...
      date: {
        path: 'tr:contains("All or Nothing") span.next-draw-date',
        transform: async (html) => {

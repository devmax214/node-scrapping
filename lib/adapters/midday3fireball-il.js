...
const gameTitle = 'Midday 3';
const gameURL = 'http://www.lotteryusa.com/illinois/';
const backupURL = 'https://www.lotterypost.com/game/53';
const jackpotURL = 'http://www.lotteryusa.com/illinois/midday-3/';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getData } from '../helpers/getData';

export const midday3fireballRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'midday3fireball',
    regions: ['IL'],
    url:gameURL,
    data: {
      numbers: {
      ...
      jackpot: {
        ...
        transform: async (html) => {
          let nextJackpot = await getData({
            url: jackpotURL,
            path: 'table.game-results tbody tr:first-child td:last-child',
            transform: async (html) => {
...
export const midday3fireballNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'midday3fireball',
    regions: ['IL'],

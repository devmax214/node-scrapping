...
export const pick3eveningksRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3eveningks',
    regions: ['KS'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick3eveningks',
    regions: ['KS'],
    url:"http://www.lotteryusa.com/kansas/pick-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick3eveningksNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3eveningks',
    regions: ['KS'],
      ...
      date: {
        ...
        transform: async (html) => {
          let date = await getData({
            url: 'https://www.lotterypost.com/game/69',

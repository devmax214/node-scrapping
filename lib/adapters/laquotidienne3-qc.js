...
const gameURL = 'http://www.lotterycanada.com/quebec-la-quotidienne-3';
const backupURL = 'https://www.lotterypost.com/game/251';
const jackpotURL = 'https://loteries.lotoquebec.com/en/lotteries/la-quotidienne';
import { getData } from '../helpers/getData';

export const laquotidienne3Recent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'laquotidienne3',
    regions: ['QC'],
    url:gameURL,
    data: {
      numbers: {
      ...
      jackpot: {
        ...
        transform: async (html) => {
          let jackpot2 = await getData({
            ...
            transform: async (html) => {
              const text = html.eq(1).text().replace(/\D/g,'');
              return parseInt(text);
            }
          });
          return jackpot2;
...
export const laquotidienne3Next = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'laquotidienne3',
    regions: ['QC'],

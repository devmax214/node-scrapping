...
export const play4nightdeRecent = [// Scraper for the recently passed draw (Primary)
  {
    lotteryName:'play4nightde',
    regions: ['DE'],
      ...
      jackpot: {
        ...
        transform: async (html) => {
          let jackpot = await getData({
            ...
            path: 'tr:contains("Play 4") span.jackpot-amount',
            transform: async (html) => {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'play4nightde',
    regions: ['DE'],
    url:"http://www.lotteryusa.com/delaware/play-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/24',

    ...
    data: {
      numbers: {
        ...
        transform: async (html) => {
          ...
          const text = row.find('.result .draw-result').eq(0).text();
          const regex = /\d+/g;

...
const backupURL = 'https://www.lotterypost.com/game/291';
const jackpotURL = 'http://lotterycorner.com/results/tn/cash-3-midday-winning-numbers.html';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getData } from '../helpers/getData';

export const cash3middaytnRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'cash3middaytn',
    regions: ['TN'],
    url:gameURL,
    data: {
      numbers: {
...
export const cash3middaytnNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'cash3middaytn',
    regions: ['TN'],

...
export const pick4daypaRecent = [// Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4daypa',
    regions: ['PA'],
    url:"https://www.palottery.state.pa.us/Games/PICK-4.aspx",
    data: {
      numbers: {
      ...
      jackpot: {
        ...
        transform: async (html) => {
          let jackpot = await getData({
            url: 'https://www.palottery.state.pa.us/Games/PICK-4/Prizes-Chances.aspx',
            path: 'table.prizeChart tr:nth-child(1) td:nth-child(4)',
            transform: async (html) => {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick4daypa',
    regions: ['PA'],
    url:"http://www.lotteryusa.com/pennsylvania/midday-pick-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {

...
const gameURL = 'http://www.lotterycanada.com/ontario-pick-4-midday';
const backupURL = 'https://www.lotterypost.com/game/403';
const jackpotURL = 'http://www.olg.ca/lotteries/games/howtoplay.do?game=pick-4';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getData } from '../helpers/getData';

export const middaypick4Recent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'middaypick4',
    regions: ['ON'],
    url:gameURL,
    data: {
      numbers: {
      ...
      jackpot: {
        ...
        transform: async (html) => {
          let nextJackpot = await getData({
            ...
            transform: async (html) => {
              const table = html.first().find(".data:contains('Prizes')").parents("table");

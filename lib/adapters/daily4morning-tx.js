...
export const daily4morningtxRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily4morningtx',
    regions: ['TX'],
    ...
    data: {
      ...
      date: {
        ...
        transform: async (html) => {
          const text = html.eq(0).text().replace('Daily 4 Morning Winning Numbers for ', '');
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'daily4morningtx',
    regions: ['TX'],
    url:"http://www.lotteryusa.com/texas/morning-pick-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const daily4morningtxNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily4morningtx',
    regions: ['TX'],
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/437',
  ...
  // Scraper for the recently passed draw (Backup)
  {
    ...
    data: {
      jackpot: {
        path: 'tr:contains("Morning Pick 4") span.next-jackpot-amount',
        transform: async (html) => {
      ...
      date: {
        path: 'tr:contains("Morning Pick 4") span.next-draw-date',
        transform: async (html) => {

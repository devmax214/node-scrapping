...
export const daily3middaycaRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily3middayca',
    regions: ['CA'],
    ...
    data: {
      numbers: {
        ...
        transform: async (html) => {
          const numbers = [];
          for(let i=2; i<4; i++){
            if(html.eq(i).text().search("Midday")!=-1){
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'daily3middayca',
    regions: ['CA'],
    url:"http://www.lotteryusa.com/california/midday-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const daily3middaycaNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily3middayca',
    regions: ['CA'],
      ...
      date: {      
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/8',

...
export const extrawcRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'extrawc',
    regions: ['WC'],
    url:"http://www.lotterycanada.com/western-extra",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'extrawc',
    regions: ['WC'],
    url:"https://www.lotterypost.com/game/260",
    data: {
      numbers: {
      ...
      jackpot: {
        ...
        transform: async (html) => {
          let jackpot = await getData({
            url: 'https://www.wclc.com/games/extra.htm',
            path: 'tr:nth-child(3) td:nth-child(2)',
            transform: async (html) => {

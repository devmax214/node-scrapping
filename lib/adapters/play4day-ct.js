...
export const play4dayctRecent = [// Scraper for the recently passed draw (Primary)
  {
    lotteryName:'play4dayct',
    regions: ['CT'],
    url:"https://www.ctlottery.org/Modules/Games/default.aspx?id=2&winners=1",
    data: {
      numbers: {
      ...
      jackpot: {
        ...
        transform: async (html) => {
          let jackpot = await getData({
            url: 'https://www.ctlottery.org/Modules/Games/default.aspx?id=2',
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'play4dayct',
    regions: ['CT'],
    url:"http://www.lotteryusa.com/connecticut/midday-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/16',

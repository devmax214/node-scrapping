...
export const daily4eveningmiRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily4eveningmi',
    regions: ['MI'],
    url:"https://www.lotterypost.com/game/103",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'daily4eveningmi',
    regions: ['MI'],
    url:"http://www.lotteryusa.com/michigan/daily-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const daily4eveningmiNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily4eveningmi',
    regions: ['MI'],

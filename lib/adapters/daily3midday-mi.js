...
export const daily3middaymiRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily3middaymi',
    regions: ['MI'],
    url:"https://www.lotterypost.com/game/105",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'daily3middaymi',
    regions: ['MI'],
    url:"http://www.lotteryusa.com/michigan/midday-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const daily3middaymiNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily3middaymi',
    regions: ['MI'],
    ...
    data: {
      ...
      date: {
        ...
        transform: async (html) => {
          const text = html.first().text();
          const date = await moment(text, "ddd, MMM DD, YYYY, h:mm A").format();
          return date;
        }
    }
}

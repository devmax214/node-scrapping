...
export const dailymillionplusieRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'dailymillionplusie',
    regions: ['IE'],
    url:"https://www.lottery.ie/prizes-and-results.aspx?game=daily-million",
    data: {
      numbers: {
        path: 'div.result-block:nth-child(6) li',
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'dailymillionplusie',
    regions: ['IE'],
    url:"https://www.lotterypost.com/game/420",
    data: {
      numbers: {
...
export const dailymillionplusieNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'dailymillionplusie',
    regions: ['IE'],

...
export const pick3daymeRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3dayme',
    regions: ['ME', 'NH', 'VT'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick3dayme',
    regions: ['ME', 'NH', 'VT'],
    url:"http://www.lotteryusa.com/maine/midday-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/225',

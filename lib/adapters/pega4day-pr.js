...
const gameTitle = 'Midday Pega 4';
const gameURL = 'http://www.lotteryusa.com/puerto-rico/';
const backupURL = 'https://www.lotterypost.com/game/433';
const jackpotURL = 'http://www.loteriasdepuertorico.com/juegos/pega4/';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getData } from '../helpers/getData';

export const pega4dayRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pega4day',
    regions: ['PR'],
    url:gameURL,
    data: {
      numbers: {
      ...
      jackpot: {
        ...
        transform: async (html) => {
          let nextJackpot = await getData({
            url: jackpotURL,
            path: '#probabilidades table tr:nth-child(2) td:nth-child(4)',
            transform: async (html) => {

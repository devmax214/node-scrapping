...
export const pick4middayilRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4middayil',
    regions: ['IL'],
    url:"https://www.lotterypost.com/game/54",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick4middayil',
    regions: ['IL'],
    url:"http://www.lotteryusa.com/illinois/midday-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick4middayilNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4middayil',
    regions: ['IL'],

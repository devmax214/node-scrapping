...
export const daily3eveninginRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily3eveningin',
    regions: ['IN'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'daily3eveningin',
    regions: ['IN'],
    url:"http://www.lotteryusa.com/indiana/daily-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const daily3eveninginNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'daily3eveningin',
    regions: ['IN'],
      ...
      date: {      
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/56',

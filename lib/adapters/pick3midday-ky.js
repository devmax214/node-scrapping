...
export const pick3middaykyRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3middayky',
    regions: ['KY'],
    url:"https://www.kylottery.com/apps/draw_games/pick3/pick3_pastwinning.html",
    data: {
      numbers: {
        path: 'td:contains("Midday") tr:nth-child(1) span.pick3clr',
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick3middayky',
    regions: ['KY'],
    url:"http://www.lotteryusa.com/kentucky/midday-pick-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const pick3middaykyNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3middayky',
    regions: ['KY'],
      ...
      date: {
        ...
        transform: async (html) => {
          let date = await getData({
            url: 'https://www.lotterypost.com/game/74',

...
export const pick4nightvaRecent = [// Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick4nightva',
    regions: ['VA'],
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick4nightva',
    regions: ['VA'],
    url:"http://www.lotteryusa.com/virginia/pick-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
      ...
      date: {
        ...
        transform: async (html) => {
          let date = await getData({
            url: 'https://www.lotterypost.com/game/193',

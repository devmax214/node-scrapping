...
export const play4middayflRecent = [
// Scraper for the recently passed draw (Primary)
  {
    lotteryName:'play4middayfl',
    regions: ['FL'],
    url:"http://www.flalottery.com/pick4",
    data: {
      numbers: {
        path: 'div.gamePageNumbers:contains("Midday") span.balls',
      ...
      date: {
        path: 'div.gamePageNumbers:contains("Midday") > p:nth-of-type(2)',
        transform: async (html) => {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'play4middayfl',
    regions: ['FL'],
    url:"http://www.lotteryusa.com/florida/midday-pick-4/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {
...
export const play4middayflNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'play4middayfl',
    regions: ['FL'],
      ...
      date: {
        ...
        transform: async (html) => {
          let nextDate = await getData({
            url: 'https://www.lotterypost.com/game/336',

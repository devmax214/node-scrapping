...
const gameTitle = 'Midday Cash 4';
const gameURL = 'http://www.lotteryusa.com/tennessee/';
const backupURL = 'https://www.lotterypost.com/game/292';
...
export const cash4middaytnRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'cash4middaytn',
    regions: ['TN'],
    url:gameURL,
    data: {
      numbers: {
...
export const cash4middaytnNext = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'cash4middaytn',
    regions: ['TN'],

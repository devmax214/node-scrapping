...
export const pick3daynmRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'pick3daynm',
    regions: ['NM'],
    url:"https://www.lotterypost.com/game/467",
    data: {
      numbers: {
  ...
  // Scraper for the recently passed draw (Backup)
  {
    lotteryName:'pick3daynm',
    regions: ['NM'],
    url:"http://www.lotteryusa.com/new-mexico/midday-pick-3/",
    data: {
      numbers: {
        path: 'ul.draw-result',
        transform: async (html) => {

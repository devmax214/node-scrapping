...
const gameTitle = 'Rolling Cash 5';
const gameURL = 'http://www.lotteryusa.com/ohio/';
const backupURL = 'https://www.lotterypost.com/game/271';
import { filterGameRow } from '../helpers/lotteryUSA';

export const rollingcash5Recent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'rollingcash5',
    regions: ['OH'],
    url:gameURL,
    data: {
      numbers: {

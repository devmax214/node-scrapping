...
const gameURL = 'http://www.lotteryusa.com/oregon/';
const backupURL = 'https://www.lotterypost.com/game/159';
import { filterGameRow } from '../helpers/lotteryUSA';
import { getJackpot, getNextJackpot } from '../helpers/lotteryPost';

export const megabucksorRecent = [
  // Scraper for the recently passed draw (Primary)
  {
    lotteryName:'megabucksor',
    regions: ['OR'],
    url:gameURL,
    data: {
      numbers: {
